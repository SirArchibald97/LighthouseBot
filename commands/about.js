    ...
    async execute(client, interaction) {
        const aboutEmbed = new EmbedBuilder()
            ...
            .addFields(
                ...
                { name: "/badges", value: "View all the currently known hidden badges and how to get them" },
                { name: "/cosmetics", value: "Search for a cosmetic and find out where to get it" },
